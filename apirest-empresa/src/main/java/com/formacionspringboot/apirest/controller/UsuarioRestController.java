...
public class UsuarioRestController 
{
	...
	{	
		Usuario usuarioEntra = usuarioService.findByUser(usuario.getUser());
		Map<String, Object> response = new HashMap<>();
		if(usuarioEntra.getUser().equals(usuario.getUser()) && usuarioEntra.getPassword().equals(usuario.getPassword())) 
		{
