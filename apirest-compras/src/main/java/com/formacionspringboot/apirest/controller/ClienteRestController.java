...
public class ClienteRestController {
	...
	{	
		...
		{
			response.put("mensaje", "El nombre introducido corresponde con un cliente");
			response.put("cliente", clienteExiste);
		}		
		else
		{
			response.put("mensaje", "El nombre introducido no corresponde con ningun cliente");
